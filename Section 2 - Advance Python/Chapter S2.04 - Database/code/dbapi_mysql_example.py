...
def createDB():
    db_conn = pymysql.connect(host='localhost', port=3306, 
                           user='root', passwd='hcl@1234', db='pythontraining')
#    import os
#    
...
#    db_conn = sqlite.connect(DB_FILE)
    ...
    try:        
        ...
        db_curs.execute("""CREATE TABLE people (
                    id INTEGER PRIMARY KEY AUTO_INCREMENT, first_name VARCHAR(20),
                    last_name VARCHAR(30), date_of_birth VARCHAR(45))""")    
    except:
        pass
...
if __name__ == "__main__":
    ...
    try:
      db_conn = createDB()
      setUser(db_conn, "Subhas", "Chandra Bose", "23.01.1897")
